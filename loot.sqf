dingus_fnc_FillLoot = {
  ...
  _clothingItems = ["U_B_GEN_Commander_F", "V_PlateCarrier2_tna_F", "H_HelmetB_Enh_tna_F", "G_Lowprofile", "V_PlateCarrierSpec_blk", "H_Watchcap_blk", "G_Bandanna_blk", "V_TacVest_gen_F", "H_Cap_police",
    "V_BandollierB_blk", "H_MilCap_blue", "G_Aviator", "V_TacVest_blk", "U_B_T_Sniper_F", "U_B_T_FullGhillie_tna_F", "U_B_CTRG_Soldier_F"];
